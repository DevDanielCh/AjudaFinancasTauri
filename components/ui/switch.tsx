  ...
  return (
    ...
    >
      <SwitchPrimitive.Thumb
        ...
        className="pointer-events-none block size-4 rounded-full bg-background shadow-sm ring-0 transition-transform data-checked:translate-x-5 rtl:data-checked:-translate-x-5"
      />
    </SwitchPrimitive.Root>
  )
}
